...
import type {CompositeBlastConfigs} from "#ke/types/blasts";

export const compositeBlasts: CompositeBlastConfigs = {
    autumn: {
        name: 'Autumn',
        id: 'autumn',
...
export const compositeBlastsWith3pp = {...compositeBlasts, ...compositeBlasts3pp} as CompositeBlastConfigs;
