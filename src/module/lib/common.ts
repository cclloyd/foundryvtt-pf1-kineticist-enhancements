...
import type {
    BlastConfig,
    BlastDamageParts,
    BlastTransformFunction,
    CompositeBlastConfig,
    SimpleBlastConfig
} from "../../types/blasts";
 ...
 */
export const defaultCompositeTransform: BlastTransformFunction = (instance: BlastFactory, dmgParts: BlastDamageParts, blastData: any, blastConfig: BlastConfig, formData: any) => {
